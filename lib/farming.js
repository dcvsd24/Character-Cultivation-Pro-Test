        ...
        while (1) {
            ...
            if (afterStamina >= 20) {
                try {
                    ...
                    Farming.recordProgress("talent", materialName, Farming.talentEquivalent(bookRequireCounts), Math.max(0, res), characterName, uid);
                    if (res > 0) {
        ...
        while (1) {
            ...
            if (afterStamina >= 20) {
                try {
                    ...
                    Farming.recordProgress("weapon", materialName, Farming.weaponEquivalent(weaponRequireCounts), Math.max(0, res), characterName, uid);
                    if (res > 0) {
        ...
        while (1) {
            ...
            if (afterStamina >= 40) {
                try {
                    ...
                    Farming.recordProgress("boss", bossName, Number(bossRequireCounts) || 0, Math.max(0, res), characterName, uid);
                    if (res > 0) {
